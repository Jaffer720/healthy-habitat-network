...
const ProductCard = ({ product }) => {
    ...
    return (
        <div onClick={()=>{Router.push(`/products/${product.id}`)}} className=" min-w-min border border-gray-200 p-4 rounded-2xl hover:shadow hover:scale-103 transition duration-200 bg-gray-50 flex flex-col justify-between">
